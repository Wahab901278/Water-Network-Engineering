...
def simulateAgingInfrastructureForCriticalJunctions(wn, aging_factor, requiredPressure, threshold_population=100, threshold_wsa=0.8, title_before="WSA Before Aging", title_after="WSA After Aging",figure_path=""):
    ...
    plt.savefig(f"{figure_path}/aging.jpg")
    plt.show()